...
from .utils1 import check_exists, makedir_exist_ok, save, load
...
class CIFAR10(Dataset):
    ...
    def __init__(self, root, split, subset, transform=None, target_transform=None):
    ...
    def __getitem__(self, index):
        img, target = Image.fromarray(self.img[index]), self.target_transform(self.target[index])
