...
def process_dataset(dataset):
    if EXP_NAME in ['MNIST', 'CIFAR10', 'CIFAR100']:
        NUM_CLASSES = dataset['train'].classes_size
...
def process_control():
    ...
    if EXP_NAME in ['MNIST']:
    ...
    elif EXP_NAME in ['CIFAR10', 'CIFAR100']:
        ...
        if cfg['data_split_mode'] == 'iid':
            ...
            raise ValueError('Not valid data_split_mode')
    elif EXP_NAME in ['PennTreebank', 'WikiText2', 'WikiText103']:
        cfg['optimizer_name'] = 'SGD'
        # cfg['lr'] = 1e-2
        cfg['momentum'] = 0.9
        cfg['weight_decay'] = 5e-4
