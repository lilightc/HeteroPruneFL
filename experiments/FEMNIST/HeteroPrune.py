...
class FEMNISTAdaptiveServer(AdaptiveServer):
    ...
    def init_clients(self):
        ...
        return models, list_usr, capacities
...
if __name__ == "__main__":
    ...
    list_models, list_users, list_capacity = server.init_clients()
    ...
    client_list = [FEMNISTAdaptiveClient(list_models[idx], config, args.use_adaptive, list_capacity[idx]) for idx in range(NUM_CLIENTS)]
